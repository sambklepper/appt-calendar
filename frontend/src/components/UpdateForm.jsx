...
export default function UpdateForm({appointment}) {
    ...
    const formattedStartDate = moment(appointment.data.startDate).format('YYYY-MM-DD')//change the format string to your preference
    const formattedEndDate = moment(appointment.data.endDate).format('YYYY-MM-DD')//change the format string to your preference
    ...
    const onSubmit = (e) => {
        const timeZonedStartDate = moment(startDate).utcOffset(-60).format('YYYY-MM-DD HH:mm')
        const timeZonedEndDate = moment(endDate).utcOffset(-60).format('YYYY-MM-DD HH:mm')
        e.preventDefault();
